...
@interface SWGModerationApi : NSObject <SWGApi>
{
...
- (void).cxx_destruct;
- (id)sendModerationResultWithResult:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (id)getUserModerationWithCompletionHandler:(CDUnknownBlockType)arg1;
- (id)getModerationFeedWithCompletionHandler:(CDUnknownBlockType)arg1;
